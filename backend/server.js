  ...
  cors({
    origin: (origin, callback) => {
      const allowedOrigins = [
        ...
        "https://i-said-yes-1.onrender.com", // shabnam 
      ];
...
app.use("/cateringusers", cateringUserRouter);
app.use("/designusers", designUserRouter);
app.use("/cateringselections", cateringSelectionRouter);
